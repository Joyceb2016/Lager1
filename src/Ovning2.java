...
/*	System.out.println("Skriv ut namn på olika rad: ");
	System.out.println();
	System.out.println("Ditt förnamn är: " + förNamn +"\n"+"Ditt mellannamn är: " + mellanNamn +"\n"+ "Ditt efternamn är: " + efterNamn);
	System.out.println();	
	System.out.println("Skriv ut namn på samma rad: ");
	System.out.println("");
	System.out.println("Ditt Namn är: " + förNamn +" "+ mellanNamn +" "+ efterNamn  +"\n");
...
*/	
// TODO mata in namn från skrivbordet
